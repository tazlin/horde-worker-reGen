...
| `text_backend_executable`        | unset                     | A backend program to launch instead of the one the worker provisions (your own build, a newer release, a backend the worker cannot yet download).                                                                                |
