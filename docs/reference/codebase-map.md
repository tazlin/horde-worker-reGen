...
| Dashboard state channel                | `process_management/ipc/supervisor_channel.py` (`WorkerStateSnapshot`, `ProcessSnapshot`, and `SupervisedProcessSnapshotSource` for processes outside `ProcessMap`) |
