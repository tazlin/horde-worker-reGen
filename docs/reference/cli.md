...
| `HORDE_WORKER_JETPACK5_XFORMERS_SHA256` | Trusted SHA256 for an independently rebuilt JetPack 5 xFormers wheel. Omit it to require the bundled tested-build hash. |
