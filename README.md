...
| Keep it running after I close the window, or reattach | [Keep it running, or reattach](docs/how-to/use-the-dashboard.md#keep-the-worker-running-when-you-close-the-dashboard) |
