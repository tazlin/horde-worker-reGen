...
def status_message(
    *,
    ...
    stall_forgiven_resets: int = 0,
    stall_forgiven_seconds: float = 0.0,
    stall_refused_resets: int = 0,
    stall_resets_in_window: int = 0,
    stall_forgiven_seconds_in_window: float = 0.0,
    ...
    return {
        ...
        "stall_forgiven_resets": stall_forgiven_resets,
        "stall_forgiven_seconds": stall_forgiven_seconds,
        "stall_refused_resets": stall_refused_resets,
        "stall_resets_in_window": stall_resets_in_window,
        "stall_forgiven_seconds_in_window": stall_forgiven_seconds_in_window,
