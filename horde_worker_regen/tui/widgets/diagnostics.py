...
(badge, title, headline, "Do this") is always visible and whose detail layer is collapsed under it; the
card itself (:class:`~horde_worker_regen.tui.widgets.finding_card.FindingCard`) is shared with the Insights
tab, so a live finding and a log finding look the same.
