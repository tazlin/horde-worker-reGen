...
class WorkerHost:
    ...
    def _status_message(self) -> dict[str, object]:
        ...
        return sp.status_message(
            ...
            stall_forgiven_resets=stall.forgiven_resets,
            stall_forgiven_seconds=stall.forgiven_seconds,
            stall_refused_resets=stall.refused_resets,
            stall_resets_in_window=stall.resets_in_window,
            stall_forgiven_seconds_in_window=stall.forgiven_seconds_in_window,
