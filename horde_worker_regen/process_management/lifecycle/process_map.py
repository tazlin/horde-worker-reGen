        ...
        for process_id, process_info in self.items():
            if process_info.process_type == HordeProcessType.INFERENCE:
                ...
                if (
                    ...
                    # Log contract: analysis/log_signatures.py (status_sampling_state).
                ...
                # Log contract: analysis/log_signatures.py (status_inference_lane).
                info_strings.append(
                    (
                ...
                # Log contract: analysis/log_signatures.py (status_aux_lane).
                info_strings.append(
