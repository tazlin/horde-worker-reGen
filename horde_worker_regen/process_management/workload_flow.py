...
:class:`~horde_worker_regen.process_management.horde_process.WorkerCapability`), the shared
:class:`~horde_worker_regen.process_management.resource_budget.CommittedReserveLedger`, and this
vocabulary.
