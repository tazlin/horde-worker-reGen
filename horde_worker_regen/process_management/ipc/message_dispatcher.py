...
class MessageDispatcher:
    ...
    async def _dispatch_buffered_message(self, message: HordeProcessMessage) -> None:
        ...
        if isinstance(message, HordeProcessHeartbeatMessage):
            ...
            if isinstance(message, HordeProcessMemoryMessage):
                ...
                receipt_level = "TRACE"
            # Log contract: analysis/log_signatures.py (ipc_drain).
            logger.log(
                receipt_level,
    ...
    def _handle_model_state_change(self, message: HordeModelStateChangeMessage) -> None:
        ...
        if message.horde_model_state != ModelLoadState.ON_DISK:
            ...
            if message.horde_model_state == ModelLoadState.LOADING:
                # Log contract: analysis/log_signatures.py (model_loading).
            ...
            if (
                ...
                if message.horde_model_state == ModelLoadState.LOADED_IN_VRAM:
                    ...
                    # Log contract: analysis/log_signatures.py (model_moved_to_system_ram).
                    loaded_message = (
            ...
            # Log contract: analysis/log_signatures.py (model_unloaded).
            logger.opt(colors=True).info(
    ...
    async def _handle_inference_result(
        ...
        *,
        ...
        if message.time_elapsed is not None:
            ...
            # Log contract: analysis/log_signatures.py (inference_finished).
            logger.opt(colors=True).info(
                "\0<fg #da9dff>"
    ...
    async def _handle_safety_result(self, message: HordeSafetyResultMessage) -> None:
        ...
        # Log contract: analysis/log_signatures.py (safety_checked).
        logger.debug(
