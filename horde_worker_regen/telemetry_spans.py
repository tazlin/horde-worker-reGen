...
def span_job_pop(*, models: str) -> Generator[logfire.LogfireSpan, None, None]:
...
@contextlib.contextmanager
def span_preload_model(*, model_name: str, process_id: int) -> Generator[logfire.LogfireSpan, None, None]:
    """Wrap model preload."""
...
@contextlib.contextmanager
def span_safety_check(*, job_id: str) -> Generator[logfire.LogfireSpan, None, None]:
...
@contextlib.contextmanager
def span_job_submit(*, job_id: str) -> Generator[logfire.LogfireSpan, None, None]:
